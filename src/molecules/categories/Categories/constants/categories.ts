...
export const categories = [
	...
	},
	{
		label: "Montaña",
		icon: TbMountain,
		description: "Esta propiedad se encuentra cercana a la cordillera!"
	},
	{
		label: "Piscina",
		icon: TbPool,
	...
	},
	{
		label: "Recreativo",
		icon: FaSkiing,
		description: "Esta propiedad contiene actividades recreativas!"
	},
	{
		label: "Mediaval",
		icon: GiCastle,
		description: "Esta propiedad tiene el estilo de un antiguo castillo!"
	},
	{
		label: "Aventurero",
		icon: GiCaveEntrance,
		description: "Esta propiedad esta cercana a hermosas cuevas!"
	},
	{
		label: "Relajante",
		icon: GiForestCamp,
	...
	},
	{
		label: "Lujoso",
		icon: IoDiamond,
		description: "Esta propiedad es muy muy lujosa y de la mayor calidad!"
	},
];
